...
<body class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
  <header class="bg-white dark:bg-gray-900 shadow-sm border-b">
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">${spec.name}</h1>
      <nav class="flex gap-4">
        <a href="#" class="px-4 py-2 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition">Login</a>
        <a href="#" class="px-4 py-2 bg-primary text-white rounded-lg hover:opacity-90 transition">Get Started</a>
      </nav>
    </div>
  </header>
  ...
  <main class="max-w-7xl mx-auto px-4 py-20 text-center">
    <h2 class="text-5xl font-bold text-gray-900 dark:text-white mb-6">
      ${spec.description || spec.name + " Platform"}
    </h2>
    <p class="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
      Built with modern technology for scale, security, and speed.
    </p>
    <div class="flex gap-4 justify-center mb-16">
      <a href="#" class="px-6 py-3 bg-primary text-white rounded-lg text-lg font-medium hover:opacity-90 transition">
        Start Free Trial
      </a>
      <a href="#" class="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-lg text-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition">
        Learn More
      </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <p class="text-gray-600 dark:text-gray-400">Enterprise-grade ${feature.toLowerCase()} capabilities.</p>
      </div>
      `).join("")}
    </div>
  </main>
  
  <footer class="bg-white dark:bg-gray-900 border-t mt-20 py-8">
    <div class="max-w-7xl mx-auto px-4 text-center text-gray-600 dark:text-gray-400">
      <p>&copy; ${new Date().getFullYear()} ${spec.name}. All rights reserved.</p>
      <p class="text-sm mt-2">Generated by INFERA WebNova</p>
    </div>
  </footer>
</body>
</html>`;
